...
public class InputView {
    ...
    private static final String REQUEST_TICHU_CALLER_NAME = "\n%s 티츄를 부를 참가자 이름을 입력해 주세요(쉼표로 구분, 없으면 x): ";
    private static final String REQUEST_TRADE_CARD = "%s님에게 줄 카드를 입력해 주세요: ";
    private static final String REQUEST_COMBINATION = "낼 조합을 선택해 주세요(쉼표로 구분, 패스는 p): ";
    ...
    public static String requestCombination() {
        System.out.printf(REQUEST_COMBINATION);
        return scanner.nextLine();
    }
